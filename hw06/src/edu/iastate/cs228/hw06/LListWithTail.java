...
public class LListWithTail<T> extends CustomClass<T>
{
   ...
   private void initializeDataFields()
   {
	...
	public T removeFirst() {
		...
		this.firstNode = firstNode.next; // Updates the value of firstNode
		numberOfEntries--; // Decrements the size
	...
	public void moveToEnd() {
		...
		this.firstNode = firstNode.next; // Modifies value of firstNode
		
		firstNode.next = null;
		
		lastNode.next = firstNode; // Sets last Node to firstNode
		lastNode = null; // Updates size
